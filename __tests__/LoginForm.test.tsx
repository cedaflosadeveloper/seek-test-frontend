...
describe('LoginForm', () => {
  ...
  it('disables submit when empty and enables when filled', async () => {
    ...
    await user.type(screen.getByLabelText(/Contraseñ?a/i, { selector: 'input' }), 'pass');
  ...
  it('toggles password visibility', async () => {
    ...
    const passwordInput = screen.getByLabelText(/Contraseñ?a/i, { selector: 'input' }) as HTMLInputElement;
